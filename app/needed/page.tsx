  ...
  return (
    <AppShell>
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {(["all", "regular", "am"] as const).map((t) => (
          <button
            ...
            className={`text-sm px-3.5 py-1.5 rounded-full border transition ${
              typeFilter === t ? "bg-ink text-white border-ink" : "border-line text-inkmuted hover:border-ink"
            }`}
          >
        ...
        {(["all", "have_spare", "no_spare"] as const).map((s) => (
          <button
            ...
            className={`text-sm px-3.5 py-1.5 rounded-full border transition ${
              sourceFilter === s ? "bg-ink text-white border-ink" : "border-line text-inkmuted hover:border-ink"
            }`}
          >
      ...
      <input
        ...
        className="w-full border border-line rounded-lg px-3 py-2 text-sm focus:border-violet mb-6"
      />
